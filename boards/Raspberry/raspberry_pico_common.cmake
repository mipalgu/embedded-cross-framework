...
# set(PICO_BOARD_INCLUDE_REL ${${board_name}_SDK_BOARD_INCDIR_REL}/${PICO_BOARD}.h)
...
function(${board_name}_post_process project board subproject executable)
    pico_sdk_init()
    set(PICO_LIBS ${${board}_LIBS})
    ...
    set(${board}_LIBS ${PICO_LIBS} PARENT_SCOPE)
endfunction()
